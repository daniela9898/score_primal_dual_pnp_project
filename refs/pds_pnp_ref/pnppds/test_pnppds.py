import cv2, datetime, glob, json, os, os, pnppds.iteration as iteration
import numpy as np
...
def test_all_images (experimental_settings_arg = {}, method_arg = {}, configs_arg = {}):
    ...
    for path_img in path_images:
        ...
        path_pictures = [os.path.join(path_result, 'GROUND_TRUTH_' + path_saveimg_base),  os.path.join(path_result, 'OBSERVATION_' + path_saveimg_base), os.path.join(path_result, 'RESULT_' + path_saveimg_base)]
    ...
    np.save(os.path.join(path_result, 'DATA_' + path_saveimg_base), datas)
